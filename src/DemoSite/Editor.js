...
export const examples = {
  "Simple Bounding Box": () => ({
    ...
    // enabledTools: ["select", "create-box", "create-point"],
    showTags: false,
    images: [
      {
        src:
      ...
      {
        src:
          "https://fastbuild-dev.s3.ap-south-1.amazonaws.com/5fb7a9ed7245de25b9756c19/plans/revisions/A%26B%20TYP%20FLOOR%20PLAN-1",
        name: "kurla",
      },
      {
        src:
